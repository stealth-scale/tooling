...
import { solveThemes } from './appearance.ts'
...
/** Holds the one theme the workspace registered, solved. */
const THEMES = solveThemes({
  kalon: {
    recipe: { accent: 200, chart: [258, 152, 292, 45, 12], neutral: 260, primary: 258 },
    title: 'Kalon',
  },
})
